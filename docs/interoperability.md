...
- Codex and Claude Docker profiles: local execution skipped on 2026-06-19 because the Docker daemon was unavailable. The required CI job runs both profiles against a non-root, read-only scratch image.
